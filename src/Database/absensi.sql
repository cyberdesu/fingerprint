...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2819494536ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=absensi&table=absen">`absensi`.`absen`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=absensi&table=siswa">`absensi`.`siswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simpeg&table=jabatan">`simpeg`.`jabatan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simpeg&table=pegawai">`simpeg`.`pegawai`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simpeg&table=prodi">`simpeg`.`prodi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simpeg&table=mahasiswa">`simpeg`.`mahasiswa`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="51583d4b41444e5864777522504e733a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="simpeg" targettable="pegawai">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `pegawai`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="simpeg" targettable="jabatan">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `jabatan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="simpeg" targettable="pegawai">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            targetdb="absensi" targettable="siswa">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `absensi`.`siswa` ( `id` INT NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="absensi" targettable="siswa">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `absensi`.`siswa` ( `id` INT NOT NULL ,  `nama` VARCHAR NOT NULL ,  `kelas` INT NOT NULL ,  `jenis kelamin` VARCHAR NOT NULL ,  `no_ortu` INT(12) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="absensi" targettable="siswa">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `absensi`.`siswa` ( `id` INT NOT NULL ,  `nama` VARCHAR NOT NULL ,  `kelas` INT NOT NULL ,  `jenis kelamin` VARCHAR NOT NULL ,  `no_ortu` INT(12) NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="absensi" targettable="siswa">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `absensi`.`siswa` ( `id` INT(1000) NOT NULL ,  `nama` VARCHAR(1000) NOT NULL ,  `kelas` INT(30) NOT NULL ,  `jenis kelamin` VARCHAR(100) NOT NULL ,  `no_ortu` INT(12) NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="absensi" targettable="siswa">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `absensi`.`siswa` ( `id` INT(255) NOT NULL ,  `nama` VARCHAR(1000) NOT NULL ,  `kelas` INT(30) NOT NULL ,  `jenis kelamin` VARCHAR(100) NOT NULL ,  `no_ortu` INT(12) NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="absensi" targettable="siswa">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">ALTER TABLE `siswa` ADD PRIMARY KEY(`id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="absensi" targettable="siswa">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `siswa`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="absensi" targettable="absen">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `absensi`.`absen` ( `id_sidikjari` INT(255) NOT NULL ,  `tanggal` DATE NOT NULL ,  `keterangan` VARCHAR(255) NOT NULL ,  `id_siswa` INT(255) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="absensi" targettable="absen">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">ALTER TABLE `absen` ADD PRIMARY KEY(`id_sidikjari`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="absensi" targettable="absen">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">ALTER TABLE `absen` ADD INDEX(`id_siswa`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="absensi" targettable="absen">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `absen`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="absensi" targettable="absen">
                            <div class="action_content">
